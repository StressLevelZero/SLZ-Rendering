...
const char* TXPErrorToStr(TXPErrorCode err)
{
	...
	case(TXP_RETURN_UNSUPPORTED_TIFF_INVALID_CHANNEL_FORMAT): return "TXP_RETURN_UNSUPPORTED_TIFF_INVALID_CHANNEL_FORMAT"; break;
	case(TXP_RETURN_UNSUPPORTED_TIFF_INVALID_CHANNEL_COUNT)	: return "TXP_RETURN_UNSUPPORTED_TIFF_INVALID_CHANNEL_COUNT"; break;
	case(TXP_RETURN_UNSUPPORTED_TIFF_TILED)					: return "TXP_RETURN_UNSUPPORTED_TIFF_TILED"; break;
	case(TXP_RETURN_UNSUPPORTED_TIFF_SEPARATE_PLANES)		: return "TXP_RETURN_UNSUPPORTED_TIFF_SEPARATE_PLANES"; break;
	case(TXP_RETURN_UNSUPPORTED_TIFF_IMAGE_BACKWARDS)		: return "TXP_RETURN_UNSUPPORTED_TIFF_IMAGE_BACKWARDS"; break;
	default: break;
	}
