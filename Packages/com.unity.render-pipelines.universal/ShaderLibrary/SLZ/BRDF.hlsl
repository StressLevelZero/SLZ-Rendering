...
#define SlzBRDFData SLZ::LagrangeGGXParams
 ...
 */
    half3 SpecBrdfFp16FusedVF(LagrangeGGXParams ggx, half roughness, half3 reflectance)
    {
 ...
 */
    half3 SpecBrdfFp16(LagrangeGGXParams ggx, half NoV, half roughness, const half3 reflectance0, const half3 reflectance90 = half3(1, 1, 1))
    {
