//Force Reimport: 1
Shader "SLZ/LitMAS/LitMAS Vertex Color AO"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        HLSLINCLUDE
        #define CBUFFER_PATH "Packages/com.unity.render-pipelines.universal/Shaders/SLZ/LitMAS/LitMASInclude/ShaderInjector/VertexAOCBuffer.hlsl"
        ENDHLSL
