Shader "SLZ/LitMAS/LitMAS AudioLink"
{
	...
	SubShader
	{
		...
		LOD 100
HLSLINCLUDE
#define CBUFFER_PATH "Packages/com.unity.render-pipelines.universal/Shaders/SLZ/LitMAS/LitMASInclude/ShaderInjector/AudioLinkCBuffer.hlsl"
ENDHLSL
		Pass
		{
			Name "Forward"
			...
			#include_with_pragmas "Packages/com.unity.render-pipelines.universal/Shaders/SLZ/LitMAS/LitMASInclude/ShaderInjector/AudioLinkForward.hlsl"
		...
		Pass
		{
			...
			#pragma fragment frag
			#include_with_pragmas "Packages/com.unity.render-pipelines.universal/ShaderLibrary/PlatformCompiler.hlsl"
			#include_with_pragmas "Packages/com.unity.render-pipelines.universal/Shaders/SLZ/LitMAS/LitMASInclude/ShaderInjector/AudioLinkDepthNormals.hlsl" 
		...
		Pass
		{
			...
			#include_with_pragmas "Packages/com.unity.render-pipelines.universal/ShaderLibrary/PlatformCompiler.hlsl"
			#include_with_pragmas "Packages/com.unity.render-pipelines.universal/Shaders/SLZ/LitMAS/LitMASInclude/ShaderInjector/AudioLinkMeta.hlsl"
			ENDHLSL
		}
		...
		Pass
		{
			...
			#include_with_pragmas "Packages/com.unity.render-pipelines.universal/Shaders/SLZ/LitMAS/LitMASInclude/ShaderInjector/AudioLinkBakedRT.hlsl"
