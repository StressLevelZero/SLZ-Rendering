...
Shader "SLZ/LitMAS/LitMAS Triplanar"
{
    ...
    SubShader
    {
        ...
        HLSLINCLUDE
        #define CBUFFER_PATH "Packages/com.unity.render-pipelines.universal/Shaders/SLZ/LitMAS/LitMASInclude/ShaderInjector/TriplanarCBuffer.hlsl"
        ENDHLSL
        ...
        Pass
        {
            ...
            #include_with_pragmas "Packages/com.unity.render-pipelines.universal/Shaders/SLZ/LitMAS/LitMASInclude/ShaderInjector/TriplanarBakedRT.hlsl"
