...
{
    struct SLZReflectionProbeManager : IDisposable
    {
        int2 m_Resolution;
        CubemapArray m_AtlasTexture0;
        ...
        public static SLZReflectionProbeManager Create()
        {
            var instance = new SLZReflectionProbeManager();
            instance.Init();
            return instance;
        }
        ...
        void Init()
        {
...
#endif
            m_AtlasTexture0 = new CubemapArray(
                m_Resolution.x,
                maxProbes,
                format,
            ...
            m_AtlasTexture0.filterMode = FilterMode.Trilinear;
            m_AtlasTexture0.hideFlags = HideFlags.DontSaveInBuild | HideFlags.DontSaveInEditor;
