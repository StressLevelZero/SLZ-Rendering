...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public partial class DrawObjectsPass : ScriptableRenderPass
    {
        ...
        */
        internal void Render(RenderGraph renderGraph, ContextContainer frameData, in TextureHandle colorTarget, in TextureHandle depthTarget, in TextureHandle mainShadowsTexture, in TextureHandle additionalShadowsTexture, in TextureHandle shadingRateTexture, uint batchLayerMask = uint.MaxValue, bool isMainOpaquePass = false)
        {
